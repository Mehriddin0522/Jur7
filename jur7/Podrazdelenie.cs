...
namespace jur7
{
    public partial class Podrazdelenie : Form
    {
        ...
        public void run_main()
        {
            try
            {
                var query = "SELECT * FROM podrazdeleniya_jur7 where podraz is not null";
            ...
            try
            {
                if (podrazdelenie_dataGridView.CurrentRow != null)
                {
                    ...
                    if (dgvRow.Cells[0].Value == null)
                    {
                        ...
                        sql.return_MySqlCommand("insert into podrazdeleniya_jur7 (type,podraz,podraz_fio) values" +
                        ...
                        sql1.myReader = sql1.return_MySqlCommand("select max(id) as id from podrazdeleniya_jur7").ExecuteReader();
                        while (sql1.myReader.Read())
                        {
                    ...
                    else
                    {
                        ...
                        sql.return_MySqlCommand("update podrazdeleniya_jur7 set " +
