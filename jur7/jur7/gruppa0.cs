        ...
        private void gruppa0_dataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (gruppa0_dataGridView.CurrentRow != null)
            {
                ...
                if (dgvRow.Cells[0].Value == null)
                {
                    ...
                    sql.return_MySqlCommand("insert into gruppa0 (gruppa,first,two,three,four,five,six,seven,eight) values" +
                    ...
                    sql1.myReader = sql1.return_MySqlCommand("select max(id) as id from gruppa0").ExecuteReader();
                    while (sql1.myReader.Read())
                    {
                ...
                else
                {
                    ...
                    sql.return_MySqlCommand("update gruppa0 set " +
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    foreach (DataGridViewRow row in gruppa0_dataGridView.SelectedRows)
                    {
                        if (row.Cells[0].Value != null)
                        {
                            ...
                            sql.return_MySqlCommand("delete from gruppa0 where id = " + row.Cells[0].Value + "").ExecuteNonQuery();
                        }
                    }
                }
                else
