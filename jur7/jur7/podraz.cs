...
namespace jur7
{
    public partial class podraz : Form
    {
        ...
        {
            var query = " SELECT * FROM podraz where kod_pod is not null order by cast(kod_pod as unsigned)  ";
        ...
        private void podrazdelenie_dataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (podrazdelenie_dataGridView.CurrentRow != null)
            {
                ...
                if (dgvRow.Cells[0].Value == null)
                {
                    ...
                    sql.return_MySqlCommand("insert into podraz (kod_pod,podraz_naim) values" +
                    ...
                    sql1.myReader = sql1.return_MySqlCommand("select max(id) as id from podraz").ExecuteReader();
                    while (sql1.myReader.Read())
                    {
        ...
        private void podrazdelenie_dataGridView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            podraz_fio gruppa = new podraz_fio(kod_pod, podraz_naim);
            if (e.ColumnIndex == 2)
            {
