...
namespace jur7
{
    public partial class prixod_document : Form
    {
        ...
        public string iznos;
        public prixod_document(string string_for_otdels, string year_global, string month_global, string iznos)
        {
            InitializeComponent();
        ...
        public void run_main()
        {
            try
            {
                ...
                var select_akt = "select max(kod_doc) as max_kod_doc from products_prixod where vid_doc='1' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
                ...
                var query3 = "select max(kod_doc) as max_kod_doc from products_prixod where vid_doc='1' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
        ...
        private void pri_save_btn_Click(object sender, EventArgs e)
        {
            ...
            if (komu_pri_comboBox.Text != "" && komu_pri_comboBox2.Text != "")
            {
                ...
                sql.myReader = sql.return_MySqlCommand("select exists(SELECT * FROM products_prixod where vid_doc='1' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ) as ex").ExecuteReader();
                while (sql.myReader.Read())
                {
                ...
                if (exist == 0)
                {
                    ...
                    for (int i = 0; i < prixod_dataGridView.Rows.Count - 1; i++)
                    {
                        if (prixod_dataGridView.Rows[i].Cells[1].Value == null)
                        {
                            ...
                            var insert_product = "insert into products (user,year,month,vid_doc,kod_doc,product_id,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,komu_1,komu_2) values(" +
                                            "'" + string_for_otdels + "'," +
                                            "'" + (year_global) + "'," +
                                            "'" + (month_global) + "'," +
                                            "'" + ("1") + "'," +
                            ...
                            var insert_product_pri = "insert into products_prixod (user,year,month,vid_doc,product_id,id_sklad_products,kod_doc,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,komu_1,komu_2) values(" +
                                             "'" + string_for_otdels + "'," +
                                             "'" + (year_global) + "'," +
                                             "'" + (month_global) + "'," +
                                             "'" + ("1") + "'," +
                        ...
                        else
                        {
                            ...
                            var id_sklad = "SELECT id FROM products where vid_doc='1' and product_id='"+ (prixod_dataGridView.Rows[i].Cells[1].Value != null ? prixod_dataGridView.Rows[i].Cells[1].Value.ToString() : "") + "' and user='"+string_for_otdels+"' and year='"+year_global+"' and month='"+month_global+"' ";
                            sql.myReader = sql.return_MySqlCommand(id_sklad).ExecuteReader();
                            while (sql.myReader.Read())
                            {
                            ...
                            var id_sklad2 = "SELECT max(id) as id_sklad FROM products";
                            ...
                            var insert_product_pri = "insert into products_prixod (user,year,month,vid_doc,id_sklad_products,kod_doc,product_id,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,komu_1,komu_2) values(" +
                                             "'" + string_for_otdels + "'," +
                                             "'" + (year_global) + "'," +
                                             "'" + (month_global) + "'," +
                                             "'" + ("1") + "'," +
                        ...
                        foreach (DataGridViewRow row in prixod_dataGridView.Rows)
                        {
                            ...
                            if (row.Cells[1].Value != null && row.Cells[0].Value != null && row.Cells[18].Value != null)
                            {
                               ...
                               " where id = " + (row.Cells[1].Value != null ? row.Cells[1].Value.ToString() : "") + "";
                                ...
                                var update2 = "update products_prixod set " +
                            ...
                            if (row.Cells[0].Value == null && row.Cells[7].Value != null)
                            {
                                ...
                                var insert_product_pri = "insert into products_prixod (user,year,month,vid_doc,kod_doc,product_id,id_sklad_products,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,komu_1,komu_2) values(" +
                                                 "'" + string_for_otdels + "'," +
                                                 "'" + (year_global) + "'," +
                                                 "'" + (month_global) + "'," +
                                                 "'" + ("1") + "'," +
        ...
        public void set_items_to_values_prixod()
        {
            try
            {
                ...
                var query = "SELECT id,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,komu_1,komu_2,vid_doc,year,month FROM products_prixod where vid_doc='1' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' group by kod_doc";
                ...
                var select_ras = "SELECT * FROM products_prixod where vid_doc='1' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ";
                ...
                while (sql.myReader.Read())
                {
                    ...
                    prixod_dataGridView.Rows[index].Cells[17].Value=(sql.myReader["date_pr"] != DBNull.Value ? (DateTime.Parse(sql.myReader.GetString("date_pr")).ToString("dd.MM.yyyy")) : null);
        ...
        public void add_items()
        {
            try
            {
                var auto = " SELECT distinct naim_tov FROM products where user='" + string_for_otdels + "' ";
                sql.myReader = sql.return_MySqlCommand(auto).ExecuteReader();
                while (sql.myReader.Read())
                {
                    column.Add(sql.myReader.GetString("naim_tov"));
                }
                sql.myReader.Close();
        ...
        private void prixod_dataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (prixod_dataGridView.SelectedCells.Count > 0)
                {
                    ...
                    if (e.ColumnIndex == 2)
                    {
                        sql.myReader = sql.return_MySqlCommand(" SELECT * FROM gruppa where kod_gruppa='"+ dgvRow.Cells[2].Value + "' ").ExecuteReader();
                        while (sql.myReader.Read())
                        {
                            //schet,subschet
                        ...
                        sql.myReader.Close();
                        // sql.myReader = sql.return_MySqlCommand("").ExecuteReader();
                    }
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    foreach (DataGridViewRow row in prixod_dataGridView.SelectedRows)
                    {
                        if (row.Cells[0].Value != null && row.Cells[18].Value != null)
                        {
                            ...
                            sql.return_MySqlCommand("delete from products_prixod where id = " + row.Cells[0].Value + "").ExecuteNonQuery();
                            sql.return_MySqlCommand("delete from products where id = " + row.Cells[1].Value + "").ExecuteNonQuery();
                        }
                    }
                }
                else
        ...
        private void komu_pri_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                var select = " SELECT * FROM podraz where podraz_naim='"+komu_pri_comboBox.Text+"' ";
        ...
        private void pri_document_btn_Click(object sender, EventArgs e)
        {
            ...
            var top = " SELECT * FROM products_prixod where kod_doc='"+kod_num_textBox.Text+"' and user='"+string_for_otdels+"' and month='"+month_global+"' and year='"+year_global+"'  ";
            ...
            while (sql.myReader.Read())
            {
                ...
                sheet.Range["k" + myrow + ":k" + myrow].Text = sql.myReader["date_pr"] != DBNull.Value ? DateTime.Parse(sql.myReader.GetString("date_pr").ToString()).ToString("dd.MM.yyyy") : "";
            ...
            var spravocnik = "SELECT fio_gl_bugalter,fio_bugalter,inspektor FROM spravochnik_main where user_jur7='"+string_for_otdels+"'";
            ...
            var schet = "SELECT deb_sch,deb_sch_2,kre_sch,sum(summa) as summa FROM products_prixod where kod_doc='"+kod_num_textBox.Text+"' and user='"+string_for_otdels+"' and month='"+month_global+"' and year='"+year_global+"' group by deb_sch";
        ...
        private void pri_naklad_btn_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["a2:k2"].Merge(); // birlashtirish
            sheet.Range["a2:k2"].Text = "№ " + num_pri_textBox.Text + "от " + data_pri_DateTimePicker.Value.ToString("dd.MM.yyyy");
            ...
            var send2 = "SELECT * FROM products_prixod where kod_doc='"+kod_num_textBox.Text+"' and user='"+string_for_otdels+"' and month='"+month_global+"' and year='"+year_global+"' ";
        ...
        private void pri_schet_fac_btn_Click(object sender, EventArgs e)
        {
            ...
            //catch (Exception ex)
            //{
            //    MessageBox.Show(ex.Message, "Счет-фастура_Excel", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //}
        }
