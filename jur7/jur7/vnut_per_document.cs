...
namespace jur7
{
    public partial class vnut_per_document : Form
    {
        ...
        public vnut_per_document(string string_for_otdels, string year_global, string month_global)
        {
            InitializeComponent();
        ...
        {
            komu_vnut_per_comboBox.Items.Clear();
            sql.myReader = sql.return_MySqlCommand("SELECT distinct podraz_naim FROM podraz").ExecuteReader();

            while (sql.myReader.Read())
            {
                komu_vnut_per_comboBox.Items.Add(sql.myReader.GetString("podraz_naim"));
            }
            sql.myReader.Close();

            ot_kogo_vnut_per_ComboBox.Items.Clear();
            sql.myReader = sql.return_MySqlCommand("SELECT distinct podraz_naim FROM podraz").ExecuteReader();

            while (sql.myReader.Read())
            {
                ot_kogo_vnut_per_ComboBox.Items.Add(sql.myReader.GetString("podraz_naim"));
            }
            sql.myReader.Close();
        }
        ...
        public void run_main()
        {
            ...
            var select_akt = "select max(kod_doc) as max_kod_doc from products_vnut_per where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
            ...
            var query3 = "select max(kod_doc) as max_kod_doc from products_vnut_per where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
        ...
        public void set_items_to_values_prixod()
        {
            ...
            //{
                ...
                jur_order_vnut_per_textBox.Text = "";
                num_vnut_per_textBox.Text = "";
                primech_vnut_per_textBox.Text = "";
                doveren_vnut_per_textBox.Text = "";
                ot_kogo_vnut_per_ComboBox.Text = "";
                ot_kogo_2_vnut_per_comboBox.Text = "";
                komu_vnut_per_comboBox.Text = "";
                komu_vnut_per_comboBox2.Text = "";

                var query = "SELECT * FROM products_vnut_per where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' group by kod_doc";
                sql.myReader = sql.return_MySqlCommand(query).ExecuteReader();
                while (sql.myReader.Read())
                {
                    jur_order_vnut_per_textBox.Text = (sql.myReader["jur_order"] != DBNull.Value ? sql.myReader.GetString("jur_order") : "");
                    num_vnut_per_textBox.Text = (sql.myReader["num_doc"] != DBNull.Value ? sql.myReader.GetString("num_doc") : "");
                    data_vnut_per_DateTimePicker.Value = (sql.myReader["date_doc"] != DBNull.Value ? sql.myReader.GetDateTime("date_doc") : DateTime.Now);
                    primech_vnut_per_textBox.Text = (sql.myReader["primech"] != DBNull.Value ? sql.myReader.GetString("primech") : "");
                    doveren_vnut_per_textBox.Text = (sql.myReader["doverennost"] != DBNull.Value ? sql.myReader.GetString("doverennost") : "");
                    ot_kogo_vnut_per_ComboBox.Text = (sql.myReader["ot_kogo"] != DBNull.Value ? sql.myReader.GetString("ot_kogo") : "");
                    ot_kogo_2_vnut_per_comboBox.Text = (sql.myReader["ot_kogo_2"] != DBNull.Value ? sql.myReader.GetString("ot_kogo_2") : "");
                    komu_vnut_per_comboBox.Text = (sql.myReader["komu_1"] != DBNull.Value ? sql.myReader.GetString("komu_1") : "");
                    komu_vnut_per_comboBox2.Text = (sql.myReader["komu_2"] != DBNull.Value ? sql.myReader.GetString("komu_2") : "");
                }
                sql.myReader.Close();

                vnut_per_dataGridView.Rows.Clear();
                var select_ras = "SELECT * FROM products_vnut_per where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ";
                ...
                while (sql.myReader.Read())
                {
                    ...
                    int index = vnut_per_dataGridView.Rows.Add();
                    vnut_per_dataGridView.Rows[index].Cells[0].Value = (sql.myReader["id"] != DBNull.Value ? sql.myReader.GetString("id") : "");
                    vnut_per_dataGridView.Rows[index].Cells[1].Value = (sql.myReader["product_id"] != DBNull.Value ? sql.myReader.GetString("product_id") : "");
                    vnut_per_dataGridView.Rows[index].Cells[2].Value = (sql.myReader["gruppa"] != DBNull.Value ? sql.myReader.GetString("gruppa") : "");
                    vnut_per_dataGridView.Rows[index].Cells[3].Value = (sql.myReader["naim_tov"] != DBNull.Value ? sql.myReader.GetString("naim_tov") : "");
                    vnut_per_dataGridView.Rows[index].Cells[4].Value = (sql.myReader["edin"] != DBNull.Value ? sql.myReader.GetString("edin") : "");
                    vnut_per_dataGridView.Rows[index].Cells[5].Value = (sql.myReader["inventar_num"] != DBNull.Value ? sql.myReader.GetString("inventar_num") : "");
                    vnut_per_dataGridView.Rows[index].Cells[6].Value = (sql.myReader["seria_num"] != DBNull.Value ? sql.myReader.GetString("seria_num") : "");
                    string kols = sql.myReader["kol"] != DBNull.Value ? sql.myReader.GetString("kol") : "";

                    if (kols.Length <= 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[7].Value = string.Format("{0:#0.00}", (sql.myReader["kol"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("kol").Replace(".", ","))) : 0));
                    }
                    if (kols.Length > 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[7].Value = string.Format("{0:#,###.00}", (sql.myReader["kol"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("kol").Replace(".", ","))) : 0));
                    }
                    ...
                    if (sena.Length <= 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[8].Value = string.Format("{0:#0.00}", (sql.myReader["sena"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("sena").Replace(".", ","))) : 0));
                    }
                    if (sena.Length > 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[8].Value = string.Format("{0:#,###.00}", (sql.myReader["sena"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("sena").Replace(".", ","))) : 0));
                    }
                    ...
                    if (summa.Length <= 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[9].Value = string.Format("{0:#0.00}", (sql.myReader["summa"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("summa").Replace(".", ","))) : 0));
                    }
                    if (summa.Length > 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[9].Value = string.Format("{0:#,###.00}", (sql.myReader["summa"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("summa").Replace(".", ","))) : 0));
                    }

                    //deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,id_products

                    vnut_per_dataGridView.Rows[index].Cells[10].Value = (sql.myReader["deb_sch"] != DBNull.Value ? sql.myReader.GetString("deb_sch") : "");
                    ...
                    if (first == "01")
                    {
                        debet_01_sum += (vnut_per_dataGridView.Rows[index].Cells[9].Value != null ? Double.Parse(vnut_per_dataGridView.Rows[index].Cells[9].Value.ToString()) : 0);
                    }
                    else if (first == "06")
                    {
                        debet_06_sum += (vnut_per_dataGridView.Rows[index].Cells[9].Value != null ? Double.Parse(vnut_per_dataGridView.Rows[index].Cells[9].Value.ToString()) : 0);
                    }
                    else if (first == "07")
                    {
                        debet_07_sum += (vnut_per_dataGridView.Rows[index].Cells[9].Value != null ? Double.Parse(vnut_per_dataGridView.Rows[index].Cells[9].Value.ToString()) : 0);
                    }

                    vnut_per_dataGridView.Rows[index].Cells[11].Value = (sql.myReader["deb_sch_2"] != DBNull.Value ? sql.myReader.GetString("deb_sch_2") : "");
                    vnut_per_dataGridView.Rows[index].Cells[12].Value = (sql.myReader["kre_sch"] != DBNull.Value ? sql.myReader.GetString("kre_sch") : "");
                    vnut_per_dataGridView.Rows[index].Cells[13].Value = (sql.myReader["kre_sch_2"] != DBNull.Value ? sql.myReader.GetString("kre_sch_2") : "");
                    vnut_per_dataGridView.Rows[index].Cells[14].Value = (sql.myReader["provodka_iznos"] != DBNull.Value ? sql.myReader.GetString("provodka_iznos") : "");
                    vnut_per_dataGridView.Rows[index].Cells[15].Value = (sql.myReader["provodka_iznos_2"] != DBNull.Value ? sql.myReader.GetString("provodka_iznos_2") : "");

                    string summa_iznos = sql.myReader["summa_iznos"] != DBNull.Value ? sql.myReader.GetString("summa_iznos") : "";

                    if (summa_iznos.Length <= 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[16].Value = string.Format("{0:#0.00}", (sql.myReader["summa_iznos"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("summa_iznos").Replace(".", ","))) : 0));
                    }
                    if (summa_iznos.Length > 3)
                    {
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[16].Value = string.Format("{0:#,###.00}", (sql.myReader["summa_iznos"] != DBNull.Value ? (Convert.ToDouble(sql.myReader.GetString("summa_iznos").Replace(".", ","))) : 0));
                    }


                    vnut_per_dataGridView.Rows[index].Cells[17].Value = (sql.myReader["date_pr"] != DBNull.Value ? sql.myReader.GetString("date_pr") : "");
                    vnut_per_dataGridView.Rows[index].Cells[18].Value = (sql.myReader["id_sklad_products"] != DBNull.Value ? sql.myReader.GetString("id_sklad_products") : "");
                    // vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[17].Value = (sql.myReader["date_pr"] != DBNull.Value ? (DateTime.Parse(sql.myReader.GetString("date_pr")).ToString("dd.MM.yyyy")) : null);
                    ...
                    //vnut_per_dataGridView.Rows[index].Cells[18].Value = (sql.myReader["id_products"] != DBNull.Value ? sql.myReader.GetString("id_products") : "");
        ...
        public void label_update_prixod()
        {
            ...
            foreach (DataGridViewRow row in vnut_per_dataGridView.Rows)
            {
            ...
            {
                vnut_per_obshiy_summa_label.Text = string.Format("{0:#0.00}", summa);
            }
            if (summa.ToString().Length > 3)
            {
                vnut_per_obshiy_summa_label.Text = string.Format("{0:#0,000.00}", summa);
            }
        ...
        private void vnut_per_document_Load(object sender, EventArgs e)
        {
        ...
        private void vnut_per_dataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            try
            {


                if (vnut_per_dataGridView.SelectedCells.Count > 0)
                {
                    DataGridViewRow dgvRow = vnut_per_dataGridView.CurrentRow;
        ...
        private void vnut_per_save_btn_Click(object sender, EventArgs e)
        {
            //try
            //{
            if (jur_order_vnut_per_textBox.Text != "" && num_vnut_per_textBox.Text != "" && ot_kogo_vnut_per_ComboBox.Text != "" && ot_kogo_2_vnut_per_comboBox.Text != "")
            {

                sql.myReader = sql.return_MySqlCommand("select exists(SELECT * FROM products_vnut_per where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ) as ex").ExecuteReader();
                while (sql.myReader.Read())
                {
                ...
                if (exist == 0)
                {
                    ...
                    for (int i = 0; i < vnut_per_dataGridView.Rows.Count - 1; i++)
                    {


                        //var naim_tov = "insert into naim_tov (naim,kod_gruppa,sena,month,year) values(" +
                        //                    "'" + (vnut_per_dataGridView.Rows[i].Cells[3].Value != null ? vnut_per_dataGridView.Rows[i].Cells[3].Value.ToString() : "") + "'," +
                        //                     "'" + (vnut_per_dataGridView.Rows[i].Cells[2].Value != null ? vnut_per_dataGridView.Rows[i].Cells[2].Value.ToString() : "") + "'," +
                        //                     "'" + refresh_strings_to_mysql(vnut_per_dataGridView.Rows[i].Cells[8].Value != null ? vnut_per_dataGridView.Rows[i].Cells[8].Value.ToString().Replace(',', '.') : "0") + "'," +
                        //                     "'" + (month_global) + "'," +
                        //                     "'" + (year_global) + "'" +
                        //                    ")";
                        ...
                        var insert_product = "insert into products (user,year,month,vid_doc,kod_doc,product_id,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,ot_kogo_2,komu_1,komu_2) values(" +
                                        "'" + string_for_otdels + "'," +
                                        "'" + (year_global) + "'," +
                                        "'" + (month_global) + "'," +
                                        "'" + ("3") + "'," +
                                        "'" + (kod_num_textBox.Text) + "'," +
                                         //"'" + (product_id) + "'," +
                                         //"'" + (product_id) + "'," +
                                         "'" + (vnut_per_dataGridView.Rows[i].Cells[1].Value != null ? vnut_per_dataGridView.Rows[i].Cells[1].Value.ToString() : "") + "'," +
                                        "'" + (vnut_per_dataGridView.Rows[i].Cells[2].Value != null ? vnut_per_dataGridView.Rows[i].Cells[2].Value.ToString() : "") + "'," +
                                         "'" + (vnut_per_dataGridView.Rows[i].Cells[3].Value != null ? vnut_per_dataGridView.Rows[i].Cells[3].Value.ToString() : "") + "'," +
                                          "'" + (vnut_per_dataGridView.Rows[i].Cells[4].Value != null ? vnut_per_dataGridView.Rows[i].Cells[4].Value.ToString() : "") + "'," +
                                          "'" + (vnut_per_dataGridView.Rows[i].Cells[5].Value != null ? vnut_per_dataGridView.Rows[i].Cells[5].Value.ToString() : "") + "'," +
                                          "'" + (vnut_per_dataGridView.Rows[i].Cells[6].Value != null ? vnut_per_dataGridView.Rows[i].Cells[6].Value.ToString() : "") + "'," +
                                        "'" + refresh_strings_to_mysql(vnut_per_dataGridView.Rows[i].Cells[7].Value != null ? vnut_per_dataGridView.Rows[i].Cells[7].Value.ToString().Replace(',', '.') : "0") + "'," +
                                        "'" + refresh_strings_to_mysql(vnut_per_dataGridView.Rows[i].Cells[8].Value != null ? vnut_per_dataGridView.Rows[i].Cells[8].Value.ToString().Replace(',', '.') : "0") + "'," +
                                        "'" + refresh_strings_to_mysql(vnut_per_dataGridView.Rows[i].Cells[9].Value != null ? vnut_per_dataGridView.Rows[i].Cells[9].Value.ToString().Replace(',', '.') : "0") + "'," +
                                        "'" + (vnut_per_dataGridView.Rows[i].Cells[10].Value != null ? vnut_per_dataGridView.Rows[i].Cells[10].Value.ToString() : "") + "'," +
                                        "'" + (vnut_per_dataGridView.Rows[i].Cells[11].Value != null ? vnut_per_dataGridView.Rows[i].Cells[11].Value.ToString() : "") + "'," +
                                         "'" + (vnut_per_dataGridView.Rows[i].Cells[12].Value != null ? vnut_per_dataGridView.Rows[i].Cells[12].Value.ToString() : "") + "'," +
                                          "'" + (vnut_per_dataGridView.Rows[i].Cells[13].Value != null ? vnut_per_dataGridView.Rows[i].Cells[13].Value.ToString() : "") + "'," +
                                          "'" + (vnut_per_dataGridView.Rows[i].Cells[14].Value != null ? vnut_per_dataGridView.Rows[i].Cells[14].Value.ToString() : "") + "'," +
                                          "'" + (vnut_per_dataGridView.Rows[i].Cells[15].Value != null ? vnut_per_dataGridView.Rows[i].Cells[15].Value.ToString() : "") + "'," +
                                        "'" + refresh_strings_to_mysql(vnut_per_dataGridView.Rows[i].Cells[16].Value != null ? vnut_per_dataGridView.Rows[i].Cells[16].Value.ToString().Replace(',', '.') : "0") + "'," +
                                       "'" + (vnut_per_dataGridView.Rows[i].Cells[17].Value != null ? vnut_per_dataGridView.Rows[i].Cells[17].Value.ToString() : "") + "'," +
                                        //"" + (vnut_per_dataGridView.Rows[i].Cells[17].Value == null ? "'" + DateTime.Parse(vnut_per_dataGridView.Rows[i].Cells[17].Value.ToString()).ToString("yyyy-MM-dd") + "'" : "NULL") + ", " +
                                        "'" + (jur_order_vnut_per_textBox.Text) + "', " +
                                        "'" + (num_vnut_per_textBox.Text) + "', " +
                                        (data_vnut_per_DateTimePicker.Text != DBNull.Value.ToString() ? "'" + DateTime.Parse(data_vnut_per_DateTimePicker.Text).ToString("yyyy-MM-dd") + "'" : "NULL") + "," +
                                        "'" + (primech_vnut_per_textBox.Text) + "', " +
                                        "'" + (doveren_vnut_per_textBox.Text) + "', " +
                                        "'" + (ot_kogo_vnut_per_ComboBox.Text) + "', " +
                                        "'" + (ot_kogo_2_vnut_per_comboBox.Text) + "', " +
                        ...
                        var id_sklad = "SELECT max(id) as id_sklad FROM products";
                        ...
                        var insert_product_pri = "insert into products_vnut_per (user,year,month,vid_doc,id_sklad_products,kod_doc,product_id,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,ot_kogo_2,komu_1,komu_2) values(" +
                                         "'" + string_for_otdels + "'," +
                                         "'" + (year_global) + "'," +
                                         "'" + (month_global) + "'," +
                                         "'" + ("3") + "'," +
                                        ...
                                        "'" + (vnut_per_dataGridView.Rows[i].Cells[1].Value != null ? vnut_per_dataGridView.Rows[i].Cells[1].Value.ToString() : "") + "'," +
                                         ...
                                         "'" + refresh_strings_to_mysql(vnut_per_dataGridView.Rows[i].Cells[16].Value != null ? vnut_per_dataGridView.Rows[i].Cells[16].Value.ToString().Replace(',', '.') : "0") + "'," +
                                          "'" + (vnut_per_dataGridView.Rows[i].Cells[17].Value != null ? vnut_per_dataGridView.Rows[i].Cells[17].Value.ToString() : "") + "'," +
                                         //"'" + (vnut_per_dataGridView.Rows[i].Cells[18].Value != null ? vnut_per_dataGridView.Rows[i].Cells[18].Value.ToString() : "") + "'," +
                                         "'" + (jur_order_vnut_per_textBox.Text) + "', " +
                                         "'" + (num_vnut_per_textBox.Text) + "', " +
                                         (data_vnut_per_DateTimePicker.Text != DBNull.Value.ToString() ? "'" + DateTime.Parse(data_vnut_per_DateTimePicker.Text).ToString("yyyy-MM-dd") + "'" : "NULL") + "," +
                                         "'" + (primech_vnut_per_textBox.Text) + "', " +
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        foreach (DataGridViewRow row in vnut_per_dataGridView.Rows)
                        {
                            ...
                            if (row.Cells[0].Value != null && row.Cells[18].Value != null)
                            {
                              ...
                              //  var update_naim = "update naim_tov set " +
                              ...
                              //  sql.return_MySqlCommand(update_naim).ExecuteNonQuery();
                                ...
                                var update = "update products set " +
                                   ...
                                   //"product_id = '" + (row.Cells[1].Value != null ? row.Cells[1].Value.ToString() : "") + "'," +
                                    ...
                                    "date_pr = '" + (row.Cells[17].Value != null ? row.Cells[17].Value.ToString() : "") + "'," +
                                    // "id_products = '" + (row.Cells[18].Value != null ? row.Cells[18].Value.ToString() : "") + "'," +
                                    "jur_order = '" + jur_order_vnut_per_textBox.Text + "'," +
                                    "num_doc = '" + num_vnut_per_textBox.Text + "'," +
                                    "date_doc = '" + (data_vnut_per_DateTimePicker.Text != DBNull.Value.ToString() ? DateTime.Parse(data_vnut_per_DateTimePicker.Text).ToString("yyyy-MM-dd") : "NULL") + "'," +
                                    "primech = '" + primech_vnut_per_textBox.Text + "'," +
                                    "doverennost = '" + doveren_vnut_per_textBox.Text + "'," +
                                    "ot_kogo = '" + ot_kogo_vnut_per_ComboBox.Text + "'," +
                                    "ot_kogo_2 = '" + ot_kogo_2_vnut_per_comboBox.Text + "'," +
                                    "komu_1 = '" + komu_vnut_per_comboBox.Text + "'," +
                                    "komu_2 = '" + komu_vnut_per_comboBox2.Text + "'" +
                                    " where id = " + row.Cells[18].Value + "";
                                sql.return_MySqlCommand(update).ExecuteNonQuery();

                                var update2 = "update products_vnut_per set " +
        ...
        private void ot_kogo_vnut_per_ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            //try
            //{
                ot_kogo_2_vnut_per_comboBox.Text = "";
                ot_kogo_2_vnut_per_comboBox.Items.Clear();
                var select = "SELECT * FROM podraz where podraz_naim='" + ot_kogo_vnut_per_ComboBox.Text + "'";
                sql3.myReader = sql3.return_MySqlCommand(select).ExecuteReader();
                while (sql3.myReader.Read())
                {
                    ot_kogo_2_vnut_per_comboBox.Items.Add(sql3.myReader["fio"] != DBNull.Value ? sql3.myReader.GetString("fio") : "");
                }
                sql3.myReader.Close();
        ...
        private void komu_vnut_per_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            //try
            //{
                komu_vnut_per_comboBox2.Text = "";
                komu_vnut_per_comboBox2.Items.Clear();
                var select = "SELECT * FROM podraz where podraz_naim='" + komu_vnut_per_comboBox.Text + "'";
                sql3.myReader = sql3.return_MySqlCommand(select).ExecuteReader();
                while (sql3.myReader.Read())
                {
                    komu_vnut_per_comboBox2.Items.Add(sql3.myReader["fio"] != DBNull.Value ? sql3.myReader.GetString("fio") : "");
                }
                sql3.myReader.Close();
        ...
        private void vnut_per_dataGridView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            //try
            //{
            ...
            string ot_kogo_1 = ot_kogo_vnut_per_ComboBox.Text;
            string ot_kogo_2 = ot_kogo_2_vnut_per_comboBox.Text;
            ...
            if (e.ColumnIndex == 3)
            {
                ...
                this.vnut_per_dataGridView.CellValueChanged -= new System.Windows.Forms.DataGridViewCellEventHandler(this.vnut_per_dataGridView_CellValueChanged);
                DataGridViewRow row_ost = vnut_per_dataGridView.CurrentRow;
                ...
                if (ostatok.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        int index = vnut_per_dataGridView.Rows.Add();
                        //vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Add()].Cells[0].Value = table.Rows[i][0];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[1].Value = table.Rows[i][1];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[2].Value = table.Rows[i][11];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[3].Value = table.Rows[i][3];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[4].Value = table.Rows[i][4];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[5].Value = table.Rows[i][14];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[6].Value = table.Rows[i][13];//string.Format("{0:#0.00}", table.Rows[i][7]);
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[7].Value = string.Format("{0:#0.00}", table.Rows[i][9]);
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[8].Value = string.Format("{0:#0.00}", table.Rows[i][6]);
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[9].Value = string.Format("{0:#0.00}", table.Rows[i][10]);
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[10].Value = table.Rows[i][2];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[11].Value = table.Rows[i][16];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[12].Value = table.Rows[i][17];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[13].Value = table.Rows[i][18];
                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[16].Value = table.Rows[i][8];

                        vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[17].Value = table.Rows[i][15];
                        //vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[17].Value = table.Rows[i][15];
                        //index++;
                        Console.WriteLine(vnut_per_dataGridView.Rows[vnut_per_dataGridView.Rows.Count - 2].Cells[17].Value);
                    }
                    this.vnut_per_dataGridView.CellValueChanged += new System.Windows.Forms.DataGridViewCellEventHandler(this.vnut_per_dataGridView_CellValueChanged);
                }
                this.vnut_per_dataGridView.CellValueChanged += new System.Windows.Forms.DataGridViewCellEventHandler(this.vnut_per_dataGridView_CellValueChanged);
        ...
        private void vnut_per_document_btn_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["c1:c1"].ColumnWidth = 6.29;
            ...
            sheet.Range["a1:m1"].Style.Font.Size = 14;
            ...
            sheet.Range["a2:m2"].Style.Font.Size = 14;
            sheet.Range["a2:m2"].Merge(); // birlashtirish
            sheet.Range["a2:m2"].Text = "ТРЕБОВАНИЕ на отпуск материалов № " + num_vnut_per_textBox.Text + " от " + data_vnut_per_DateTimePicker.Value.ToString("dd.MM.yyyy");
            ...
            sheet.Range["b3:j3"].Text = "Выдатъ(откуда): " + ot_kogo_2_vnut_per_comboBox.Text + " " + ot_kogo_vnut_per_ComboBox.Text;
            ...
            sheet.Range["b4:j4"].Style.Font.Size = 12;
            sheet.Range["b4:j4"].Merge(); // birlashtirish
            sheet.Range["b4:j4"].Text = "Основание: " + primech_vnut_per_textBox.Text;
            sheet.Range["b4:j4"].Style.WrapText = true;
            sheet.SetRowHeight(4, 18);

            sheet.Range["b5:j5"].Style.Font.IsBold = true;
            //sheet.Range["b5:j5"].Style.Font.IsItalic = true;
            sheet.Range["b5:j5"].Style.Font.FontName = "Times New Roman";
            sheet.Range["b5:j5"].Style.VerticalAlignment = VerticalAlignType.Center;
            sheet.Range["b5:j5"].Style.HorizontalAlignment = HorizontalAlignType.Left;
            sheet.Range["b5:j5"].Style.Font.Size = 12;
            sheet.Range["b5:j5"].Merge(); // birlashtirish
            sheet.Range["b5:j5"].Text = "Кому: " + komu_vnut_per_comboBox2.Text+" "+komu_vnut_per_comboBox.Text;
            sheet.Range["b5:j5"].Style.WrapText = true;
            ...
            sheet.Range["c6:c6"].Style.Font.Size = 10;
            ...
            var top = " SELECT * FROM products_vnut_per where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "'  ";
            ...
            String[] arr = refresh_strings_to_mysql(vnut_per_obshiy_summa_label.Text).Split('.');
            ...
            sheet.Range["i" + myrow + ":j" + myrow].Value = vnut_per_obshiy_summa_label.Text;
            ...
            sheet.Range["b" + myrow + ":d" + myrow].Text = "Нач.ФЕО: ";
            sheet.SetRowHeight(myrow, 18);
            myrow++;
            ...
            sheet.Range["b" + myrow + ":d" + myrow].Style.Font.Size = 11;
            sheet.Range["b" + myrow + ":d" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["b" + myrow + ":d" + myrow].Text = "Нач.Отдел: ";
            ...
            sheet.Range["b" + myrow + ":d" + myrow].Style.Font.Size = 11;
            sheet.Range["b" + myrow + ":d" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["b" + myrow + ":d" + myrow].Text = "Гл.Спец: ";

            var schet = "SELECT deb_sch,deb_sch_2,kre_sch,sum(summa) as summa FROM products_vnut_per where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' group by deb_sch";
        ...
        private void vnut_per_izv_btn_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["b3:k3"].Text = "о безвозмездной передаче основныих средств № " + num_vnut_per_textBox.Text + " от " + data_vnut_per_DateTimePicker.Value.ToString("dd.MM.yyyy");
            ...
            sheet.Range["a4:k4"].Text = "Кому: " + komu_vnut_per_comboBox2.Text;
            ...
            sheet.Range["e5:k5"].Text = "Получателъ: " + komu_vnut_per_comboBox2.Text;
            ...
            sheet.Range["a6:k6"].Text = "Основание на передачу(распоряжение № и дата): " + primech_vnut_per_textBox.Text;
            ...
            sheet.Range["a7:c7"].Text = "№ Доверенност: " + doveren_vnut_per_textBox.Text;
            ...
            sheet.Range["d7:g7"].Text = "№ Требование: " + num_vnut_per_textBox.Text;
            ...
            while (sql.myReader.Read())
            {
                ...
                sheet.Range["k" + myrow + ":k" + myrow].Style.Font.Size = 10;
                sheet.Range["k" + myrow + ":k" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["k" + myrow + ":k" + myrow].Text = sql.myReader["date_pr"] != DBNull.Value ? sql.myReader.GetString("date_pr").ToString() : "";
            ...
            sheet.Range["f" + myrow + ":g" + myrow].Value = vnut_per_obshiy_summa_label.Text;
            ...
            sheet.Range["a" + myrow + ":h" + myrow].Style.Font.Size = 11;
            sheet.Range["a" + myrow + ":h" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["a" + myrow + ":h" + myrow].Text = komu_vnut_per_comboBox2.Text;
        ...
        private void vnut_per_spisok_btn_Click(object sender, EventArgs e)
        {
            //try
            //{
            Spire.Xls.Workbook workbook = new Spire.Xls.Workbook();
            ...
            sheet.Range["a1:k1"].Text = "СЧЕТ-ФАКТУРА-НАКЛАДНАЯ";
            // sheet.Range["B6:B6"].BorderAround(LineStyleType.Thin);

            sheet.Range["a2:k2"].Style.Font.IsBold = false;
            sheet.Range["a2:k2"].Style.Font.FontName = "Times New Roman";
            sheet.Range["a2:k2"].Style.VerticalAlignment = VerticalAlignType.Center;
            sheet.Range["a2:k2"].Style.HorizontalAlignment = HorizontalAlignType.Center;
            sheet.Range["a2:k2"].Style.Font.Size = 12;
            sheet.Range["a2:k2"].Merge(); // birlashtirish
            sheet.Range["a2:k2"].Text = "№ " + num_vnut_per_textBox.Text + "от " + data_vnut_per_DateTimePicker.Value.ToString("dd.MM.yyyy");
            ...
            var send = "SELECT * FROM spravochnik_main where user_jur7='" + string_for_otdels + "'";
            ...
            var send2 = "SELECT * FROM products_vnut_per where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' ";
        ...
        private void vnut_per_naklad_btn_Click(object sender, EventArgs e)
        {
            ...
            sql.myReader = sql.return_MySqlCommand(send).ExecuteReader();
            while (sql.myReader.Read())
            {
                sheet.Range["a5:d5"].Style.Font.IsBold = false;
                sheet.Range["a5:d5"].Style.Font.FontName = "Times New Roman";
                ...
                sheet.Range["a5:d5"].Style.Font.Size = 11;
                sheet.Range["a5:d5"].Merge(); // birlashtirish
                sheet.Range["a5:d5"].Text = "Поставщик :" + (sql.myReader["naim_org"] != DBNull.Value ? sql.myReader.GetString("naim_org") : "");
                sheet.Range["a5:d5"].Style.Font.Underline = FontUnderlineType.SingleAccounting;
                // sheet.Range["B6:B6"].BorderAround(LineStyleType.Thin);
                ...
                sheet.Range["a6:d6"].Style.Font.Size = 11;
                sheet.Range["a6:d6"].Merge(); // birlashtirish
                sheet.Range["a6:d6"].Text = "Адрес :" + (sql.myReader["adres"] != DBNull.Value ? sql.myReader.GetString("adres") : "");
                sheet.Range["a6:d6"].Style.Font.Underline = FontUnderlineType.SingleAccounting;
                // sheet.Range["B6:B6"].BorderAround(LineStyleType.Thin);
                ...
                sheet.Range["a7:d7"].Style.Font.Size = 11;
                sheet.Range["a7:d7"].Merge(); // birlashtirish
                sheet.Range["a7:d7"].Text = "Р/с :" + (sql.myReader["ras_s"] != DBNull.Value ? sql.myReader.GetString("ras_s") : "");
                sheet.Range["a7:d7"].Style.Font.Underline = FontUnderlineType.SingleAccounting;
                // sheet.Range["B6:B6"].BorderAround(LineStyleType.Thin);
                ...
                sheet.Range["a8:d8"].Style.Font.Size = 11;
                sheet.Range["a8:d8"].Merge(); // birlashtirish
                sheet.Range["a8:d8"].Text = "Банк : " + (sql.myReader["bank"] != DBNull.Value ? sql.myReader.GetString("bank") : "");
                sheet.Range["a8:d8"].Style.Font.Underline = FontUnderlineType.SingleAccounting;
                // sheet.Range["B6:B6"].BorderAround(LineStyleType.Thin);
                ...
                sheet.Range["a9:d9"].Style.Font.Size = 11;
                sheet.Range["a9:d9"].Merge(); // birlashtirish
                sheet.Range["a9:d9"].Text = "МФО :" + (sql.myReader["mfo"] != DBNull.Value ? sql.myReader.GetString("mfo") : "");
                sheet.Range["a9:d9"].Style.Font.Underline = FontUnderlineType.SingleAccounting;
                // sheet.Range["B6:B6"].BorderAround(LineStyleType.Thin);
                ...
                sheet.Range["a10:d10"].Style.Font.Size = 11;
                sheet.Range["a10:d10"].Merge(); // birlashtirish
                sheet.Range["a10:d10"].Text = "ИНН : " + (sql.myReader["inn"] != DBNull.Value ? sql.myReader.GetString("inn") : "") + "  " + "ОКЭТ :" + (sql.myReader["okxn"] != DBNull.Value ? sql.myReader.GetString("okxn") : "");
                sheet.Range["a10:d10"].Style.Font.Underline = FontUnderlineType.SingleAccounting;
                // sheet.Range["B6:B6"].BorderAround(LineStyleType.Thin);
            }
            sql.myReader.Close();
        ...
        private void vnut_per_spisanie_btn_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["a5:k5"].Text = "Акт списания № " + num_vnut_per_textBox.Text + " от " + data_vnut_per_DateTimePicker.Value.ToString("dd.MM.yyyy");
            ...
            sheet.Range["b6:k6"].Text = "От кого :" + ot_kogo_2_vnut_per_comboBox.Text + " " + ot_kogo_vnut_per_ComboBox.Text + " " + primech_vnut_per_textBox.Text;
            ...
            sheet.Range["e" + myrow + ":f" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["e" + myrow + ":f" + myrow].Value = vnut_per_obshiy_summa_label.Text;
            sheet.Range["e" + myrow + ":f" + myrow].Style.WrapText = true;
            sheet.Range["e" + myrow + ":f" + myrow].Style.Font.IsBold = true;
            ...
            var schet = "SELECT deb_sch,deb_sch_2,kre_sch,kre_sch_2,sum(summa) as summa FROM products_vnut_per where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' group by deb_sch";
        ...
        private void vnut_per_pereosenka_btn_Click(object sender, EventArgs e)
        {
            //try
            //{
            // month_global = month_textBox.Text;
        ...
        private void vnut_per_dataGridView_UserDeletingRow(object sender, DataGridViewRowCancelEventArgs e)
        {
            try
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    foreach (DataGridViewRow row in vnut_per_dataGridView.SelectedRows)
                    {
                        if (row.Cells[0].Value != null && row.Cells[18].Value != null)
                        {

                            sql.return_MySqlCommand("delete from products_vnut_per where id = " + row.Cells[0].Value + "").ExecuteNonQuery();
                            sql.return_MySqlCommand("delete from products where id = " + row.Cells[18].Value + "").ExecuteNonQuery();
                        }
                    }
                }
                else
