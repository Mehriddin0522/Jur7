...
namespace jur7
{
    public partial class rasxod_document : Form
    {
        ...
        public rasxod_document(string string_for_otdels, string year_global, string month_global)
        {
            InitializeComponent();
            sql.Connection();
            sql2.Connection();
        ...
        public void run_main()
        {
            ...
            var select_akt = "select max(kod_doc) as max_kod_doc from products_rasxod where vid_doc='2' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
            ...
            var query3 = "select max(kod_doc) as max_kod_doc from products_rasxod where vid_doc='2' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
        ...
        public void set_items_to_values_prixod()
        {
            try
            {
                ...
                var query = "SELECT id,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,ot_kogo_2,komu_1,year,month FROM products_rasxod where vid_doc='2' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' order by kod_doc";
                ...
                var select_ras = "SELECT * FROM products_rasxod where vid_doc='2' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ";
        ...
        private void ot_kogo_ras_ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                var select = "SELECT * FROM podraz where podraz_naim='" + ot_kogo_ras_ComboBox.Text + "'";
        ...
        private void ras_save_btn_Click(object sender, EventArgs e)
        {
            ...
            if (jur_order_ras_textBox.Text != "" && num_ras_textBox.Text != "" && ot_kogo_ras_ComboBox.Text != "" && ot_kogo_ras_comboBox2.Text !="")
            {
                ...
                sql.myReader = sql.return_MySqlCommand("select exists(SELECT * FROM products_rasxod where vid_doc='2' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ) as ex").ExecuteReader();
                while (sql.myReader.Read())
                {
                ...
                if (exist == 0)
                {
                    ...
                    for (int i = 0; i < rasxod_dataGridView.Rows.Count - 1; i++)
                    {
                        ...
                        var insert_product = "insert into products (user,year,month,vid_doc,kod_doc,product_id,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,ot_kogo_2,komu_1) values(" +
                                        "'" + string_for_otdels + "'," +
                                        "'" + (year_global) + "'," +
                                        "'" + (month_global) + "'," +
                                        "'" + ("2") + "'," +
                        ...
                        var insert_product_pri = "insert into products_rasxod (user,year,month,vid_doc,id_sklad_products,kod_doc,product_id,gruppa,naim_tov,edin,inventar_num,seria_num,kol,sena,summa,deb_sch,deb_sch_2,kre_sch,kre_sch_2,provodka_iznos,provodka_iznos_2,summa_iznos,date_pr,jur_order,num_doc,date_doc,primech,doverennost,ot_kogo,ot_kogo_2,komu_1) values(" +
                                         "'" + string_for_otdels + "'," +
                                         "'" + (year_global) + "'," +
                                         "'" + (month_global) + "'," +
                                         "'" + ("2") + "'," +
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        foreach (DataGridViewRow row in rasxod_dataGridView.Rows)
                        {
                            ...
                            if (row.Cells[1].Value != null && row.Cells[0].Value != null && row.Cells[18].Value != null)
                            {
                                ...
                                var update2 = "update products_rasxod set " +
        ...
        private void ras_document_btn_Click(object sender, EventArgs e)
        {
            ...
            var top = " SELECT * FROM products_rasxod where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "'  ";
        ...
        private void ras_spisanie_btn_Click(object sender, EventArgs e)
        {
            ...
            var schet = "SELECT deb_sch,deb_sch_2,kre_sch,kre_sch_2,sum(summa) as summa FROM products_prixod where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' group by deb_sch";
        ...
        private void ras_naklad_btn_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["a2:k2"].Merge(); // birlashtirish
            sheet.Range["a2:k2"].Text = "№ " + num_ras_textBox.Text + "от " + data_ras_DateTimePicker.Value.ToString("dd.MM.yyyy");
            ...
            var send2 = "SELECT * FROM products_rasxod where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' ";
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    foreach (DataGridViewRow row in rasxod_dataGridView.SelectedRows)
                    {
                        if (row.Cells[0].Value != null && row.Cells[18].Value != null)
                        {
                            ...
                            sql.return_MySqlCommand("delete from products_rasxod where id = " + row.Cells[0].Value + "").ExecuteNonQuery();
