...
namespace jur7
{
    public partial class vnut_per_document : Form
    {
        ...
        public vnut_per_document(string string_for_otdels, string year_global, string month_global, string iznos)
        {
            InitializeComponent();
        ...
        public void run_main()
        {
            try
            {
                ...
                var select_akt = "select max(kod_doc) as max_kod_doc from products_vnut_per_jur7 where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
                ...
                var query3 = "select max(kod_doc) as max_kod_doc from products_vnut_per_jur7 where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and user='" + string_for_otdels + "' ORDER BY kod_doc desc";
        ...
        public void set_items_to_values_prixod()
        {
            try
            {
                ...
                var query = "SELECT * FROM products_vnut_per_jur7 where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' group by kod_doc";
                ...
                var select_ras = "SELECT * FROM products_vnut_per_jur7 where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ";
        ...
        private void vnut_per_save_btn_Click(object sender, EventArgs e)
        {
            try
            {
                if (jur_order_vnut_per_textBox.Text != "" && num_vnut_per_textBox.Text != "" && ot_kogo_vnut_per_ComboBox.Text != "" && ot_kogo_2_vnut_per_comboBox.Text != "")
                {
                    ...
                    sql.myReader = sql.return_MySqlCommand("select exists(SELECT * FROM products_vnut_per_jur7 where vid_doc='3' and year='" + year_global + "' and month='" + month_global + "' and kod_doc='" + naryad_num_prixod_int + "' and user='" + string_for_otdels + "' ) as ex").ExecuteReader();
                    while (sql.myReader.Read())
                    {
        ...
        private void ot_kogo_vnut_per_ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                var select = "SELECT * FROM podraz_jur7 where podraz_naim='" + ot_kogo_vnut_per_ComboBox.Text + "'";
        ...
        private void komu_vnut_per_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                var select = "SELECT * FROM podraz_jur7 where podraz_naim='" + komu_vnut_per_comboBox.Text + "'";
                sql3.myReader = sql3.return_MySqlCommand(select).ExecuteReader();
                while (sql3.myReader.Read())
                {
        ...
        private void vnut_per_document_btn_Click(object sender, EventArgs e)
        {
            ...
            var top = " SELECT * FROM products_vnut_per_jur7 where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "'  ";
            ...
            var schet = "SELECT deb_sch,deb_sch_2,kre_sch,sum(summa) as summa FROM products_vnut_per_jur7 where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' group by deb_sch";
        ...
        private void vnut_per_spisok_btn_Click(object sender, EventArgs e)
        {
            ...
            var send2 = "SELECT * FROM products_vnut_per_jur7 where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' ";
        ...
        private void vnut_per_naklad_btn_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["a2:e2"].Text = "№ " + num_vnut_per_textBox.Text + "от " + data_vnut_per_DateTimePicker.Value.ToString("dd.MM.yyyy") + "     ";
            ...
            string filePath = Environment.CurrentDirectory + "\\docs\\qrcode\\" + string_for_otdels + "-" + year_global + "-" + month_global + "-" + kod_num + "-" + "3" + ".png";
            FileInfo file = new FileInfo(filePath);
            if (file.Exists)
            {
                string picPath = Environment.CurrentDirectory + "\\docs\\qrcode\\" + string_for_otdels + "-" + year_global + "-" + month_global + "-" + kod_num + "-" + "3" + ".png";
            ...
            else
            {
                ...
                QRCodeData qrCodeData = qrGenerator.CreateQrCode((string_for_otdels + "-" + year_global + "-" + month_global + "-" + kod_num + "-" + "3"), QRCodeGenerator.ECCLevel.Q);
                QRCode qrCode = new QRCode(qrCodeData);

                Bitmap bitMap = qrCode.GetGraphic(20);

                bitMap.Save(Environment.CurrentDirectory + "\\docs\\qrcode\\" + string_for_otdels + "-" + year_global + "-" + month_global + "-" + kod_num + "-" + "3" + ".png");
        ...
        private void vnut_per_spisanie_btn_Click(object sender, EventArgs e)
        {
            ...
            var schet = "SELECT deb_sch,deb_sch_2,kre_sch,kre_sch_2,sum(summa) as summa FROM products_vnut_per_jur7 where kod_doc='" + kod_num_textBox.Text + "' and user='" + string_for_otdels + "' and month='" + month_global + "' and year='" + year_global + "' group by deb_sch";
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    foreach (DataGridViewRow row in vnut_per_dataGridView.SelectedRows)
                    {
                        if (row.Cells[0].Value != null && row.Cells[18].Value != null)
                        {
                            ...
                            sql.return_MySqlCommand("delete from products_vnut_per_jur7 where id = " + row.Cells[0].Value + "").ExecuteNonQuery();
        ...
        private void vnut_per_dataGridView_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
            if (e.Exception.Message == "DataGridViewComboBoxCell value is not valid.")
            {
                object value = vnut_per_dataGridView.Rows[e.RowIndex].Cells[e.ColumnIndex].Value;
                if (!((DataGridViewComboBoxColumn)vnut_per_dataGridView.Columns[e.ColumnIndex]).Items.Contains(value))
                {
                    ((DataGridViewComboBoxColumn)vnut_per_dataGridView.Columns[e.ColumnIndex]).Items.Add(value);
