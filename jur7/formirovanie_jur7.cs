...
namespace jur7
{
    public partial class formirovanie_jur7 : Form
    {
        ...
        private void prixod_btn_Click(object sender, EventArgs e)
        {
            ...
            var top = " SELECT id,user,year,month,vid_doc,kod_doc,date_doc,ot_kogo_2,komu_1,deb_sch,kre_sch,summa FROM products_rasxod_jur7 where user='" + string_for_otdels + "' and year='" + year_global + "' and month='" + month_global + "' " +
                      "  union all" +
                      "  SELECT id,user,year,month,vid_doc,kod_doc,date_doc,ot_kogo_2,komu_2,deb_sch,kre_sch,summa FROM products_vnut_per_jur7 where user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' ";
            ...
            var itog = "select t.kre_sch as kre_sch,sum(t.summa) as summa from(" +
                       " SELECT SUBSTRING(kre_sch, 1, 2) as kre_sch,sum(summa) as summa FROM products_rasxod_jur7 where user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' group by SUBSTRING(kre_sch, 1, 2)" +
                       " union all" +
                       " SELECT SUBSTRING(kre_sch, 1, 2) as kre_sch,sum(summa) as summa FROM products_vnut_per_jur7 where user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' group by SUBSTRING(kre_sch, 1, 2)" +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["a1:a1"].ColumnWidth = 3;
            sheet.Range["b1:b1"].ColumnWidth = 17;
            ...
            var schet = " SELECT schet,SUBSTRING(schet, 1, 2) AS tarxum FROM gruppa_jur7 group by schet ";
            sql3.myReader = sql3.return_MySqlCommand(schet).ExecuteReader();
            while (sql3.myReader.Read())
            {
                deb_schet = (sql3.myReader["schet"] != DBNull.Value ? sql3.myReader.GetString("schet") : "");

                myrow++;
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.IsBold = true;
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.IsItalic = true;
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["b" + myrow + ":b" + myrow].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["b" + myrow + ":b" + myrow].Style.HorizontalAlignment = HorizontalAlignType.Left;
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.Size = 12;
                sheet.Range["b" + myrow + ":b" + myrow].Merge(); // birlashtirish
                sheet.Range["b" + myrow + ":b" + myrow].Text = " Талмум" + ((sql3.myReader["tarxum"] != DBNull.Value ? sql3.myReader.GetString("tarxum") : ""));
                sheet.Range["b" + myrow + ":b" + myrow].Style.WrapText = true;
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.Color = Color.DarkBlue;
                ...
                sheet.Range["a" + myrow + ":b" + myrow].Style.Font.Size = 10;
                sheet.Range["a" + myrow + ":b" + myrow].Merge(); // birlashtirish
                sheet.Range["a" + myrow + ":b" + myrow].Text = "   " + deb_schet;
                ...
                sheet.Range["a" + myrow + ":a" + myrow2].Style.Font.FontName = "Times New Roman";
                sheet.Range["a" + myrow + ":a" + myrow2].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["a" + myrow + ":a" + myrow2].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["a" + myrow + ":a" + myrow2].Style.Font.Size = 11;
                sheet.Range["a" + myrow + ":a" + myrow2].Merge(); // birlashtirish
                sheet.Range["a" + myrow + ":a" + myrow2].Text = "№ п.п";
                sheet.Range["a" + myrow + ":a" + myrow2].Style.WrapText = true;
                sheet.Range["a" + myrow + ":a" + myrow2].BorderAround(LineStyleType.Thin);


                sheet.Range["b" + myrow + ":b" + myrow2].Style.Font.FontName = "Times New Roman";
                sheet.Range["b" + myrow + ":b" + myrow2].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["b" + myrow + ":b" + myrow2].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["b" + myrow + ":b" + myrow2].Style.Font.Size = 11;
                sheet.Range["b" + myrow + ":b" + myrow2].Merge(); // birlashtirish
                sheet.Range["b" + myrow + ":b" + myrow2].Text = "ФИО";
                sheet.Range["b" + myrow + ":b" + myrow2].Style.WrapText = true;
                sheet.Range["b" + myrow + ":b" + myrow2].BorderAround(LineStyleType.Thin);


                sheet.Range["c" + myrow + ":c" + myrow2].Style.Font.FontName = "Times New Roman";
                sheet.Range["c" + myrow + ":c" + myrow2].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["c" + myrow + ":c" + myrow2].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["c" + myrow + ":c" + myrow2].Style.Font.Size = 11;
                sheet.Range["c" + myrow + ":c" + myrow2].Merge(); // birlashtirish
                sheet.Range["c" + myrow + ":c" + myrow2].Text = "Подраздел.";
                sheet.Range["c" + myrow + ":c" + myrow2].Style.WrapText = true;
                sheet.Range["c" + myrow + ":c" + myrow2].BorderAround(LineStyleType.Thin);


                sheet.Range["d" + myrow + ":g" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["d" + myrow + ":g" + myrow].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["d" + myrow + ":g" + myrow].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["d" + myrow + ":g" + myrow].Style.Font.Size = 11;
                sheet.Range["d" + myrow + ":g" + myrow].Merge(); // birlashtirish
                sheet.Range["d" + myrow + ":g" + myrow].Text = "Материалный оборот";
                sheet.Range["d" + myrow + ":g" + myrow].Style.WrapText = true;
                sheet.Range["d" + myrow + ":g" + myrow].BorderAround(LineStyleType.Thin);


                sheet.Range["d" + myrow2 + ":d" + myrow2].Style.Font.FontName = "Times New Roman";
                sheet.Range["d" + myrow2 + ":d" + myrow2].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["d" + myrow2 + ":d" + myrow2].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["d" + myrow2 + ":d" + myrow2].Style.Font.Size = 11;
                sheet.Range["d" + myrow2 + ":d" + myrow2].Merge(); // birlashtirish
                sheet.Range["d" + myrow2 + ":d" + myrow2].Text = "Нач.Салъдо";
                sheet.Range["d" + myrow2 + ":d" + myrow2].Style.WrapText = true;
                sheet.Range["d" + myrow2 + ":d" + myrow2].BorderAround(LineStyleType.Thin);


                sheet.Range["e" + myrow2 + ":e" + myrow2].Style.Font.FontName = "Times New Roman";
                sheet.Range["e" + myrow2 + ":e" + myrow2].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["e" + myrow2 + ":e" + myrow2].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["e" + myrow2 + ":e" + myrow2].Style.Font.Size = 11;
                sheet.Range["e" + myrow2 + ":e" + myrow2].Merge(); // birlashtirish
                sheet.Range["e" + myrow2 + ":e" + myrow2].Text = "Приход";
                sheet.Range["e" + myrow2 + ":e" + myrow2].Style.WrapText = true;
                sheet.Range["e" + myrow2 + ":e" + myrow2].BorderAround(LineStyleType.Thin);


                sheet.Range["f" + myrow2 + ":f" + myrow2].Style.Font.FontName = "Times New Roman";
                sheet.Range["f" + myrow2 + ":f" + myrow2].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["f" + myrow2 + ":f" + myrow2].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["f" + myrow2 + ":f" + myrow2].Style.Font.Size = 11;
                sheet.Range["f" + myrow2 + ":f" + myrow2].Merge(); // birlashtirish
                sheet.Range["f" + myrow2 + ":f" + myrow2].Text = "Расход";
                sheet.Range["f" + myrow2 + ":f" + myrow2].Style.WrapText = true;
                sheet.Range["f" + myrow2 + ":f" + myrow2].BorderAround(LineStyleType.Thin);


                sheet.Range["g" + myrow2 + ":g" + myrow2].Style.Font.FontName = "Times New Roman";
                sheet.Range["g" + myrow2 + ":g" + myrow2].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["g" + myrow2 + ":g" + myrow2].Style.HorizontalAlignment = HorizontalAlignType.Center;
                sheet.Range["g" + myrow2 + ":g" + myrow2].Style.Font.Size = 11;
                sheet.Range["g" + myrow2 + ":g" + myrow2].Merge(); // birlashtirish
                sheet.Range["g" + myrow2 + ":g" + myrow2].Text = "Остаток";
                sheet.Range["g" + myrow2 + ":g" + myrow2].Style.WrapText = true;
                sheet.Range["g" + myrow2 + ":g" + myrow2].BorderAround(LineStyleType.Thin);
                //sheet.SetRowHeight(4, 18);
                ...
                var select = "SELECT podraz_naim FROM podraz_jur7 group by podraz_naim";

                sql.myReader = sql.return_MySqlCommand(select).ExecuteReader();
                ...
                while (sql.myReader.Read())
                {
                    ...
                    var selec_2 = "SELECT fio FROM podraz_jur7 where podraz_naim='" + podraz_1 + "' and fio is not null";

                    sql1.myReader = sql1.return_MySqlCommand(selec_2).ExecuteReader();
                    ...
                    while (sql1.myReader.Read())
                    {
                        ...
                        var saldo = " select id, '' as vid_doc,'' as kod_doc,product_id,gruppa, naim_tov, edin, inventar_num, seria_num,kol,sena,sum(summa) as summa,deb_sch, deb_sch_2, kre_sch, kre_sch_2, '' as provodka_iznos," +
                                    " '' as provodka_iznos_2,summa_iznos, data_pr from saldo_jur7 where user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and kol > 0 and podraz_1 = '" + podraz_1 + "' and podraz_2 = '" + podraz_2 + "' and deb_sch='" + deb_schet + "' group by deb_sch,month  ";
                        sql2.myReader = sql2.return_MySqlCommand(saldo).ExecuteReader();

                        while (sql2.myReader.Read())
                        {
                            saldo_sum = (sql2.myReader["summa"] != DBNull.Value ? sql2.myReader.GetDouble("summa") : 0);
                        }

                        sql2.myReader.Close();


                        var pri = " select sum(t.summa) as summa from( " +
                                  " SELECT* FROM products_jur7 where vid_doc = '1' and user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and kol > 0 and komu_1 = '" + podraz_1 + "' and komu_2 = '" + podraz_2 + "' group by product_id" +
                                  " union all" +
                                  " SELECT* FROM products_jur7 where vid_doc = '3' and user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and kol > 0 and komu_1 = '" + podraz_1 + "' and komu_2 = '" + podraz_2 + "' group by product_id" +
                                  " ) as t ";
                        sql2.myReader = sql2.return_MySqlCommand(pri).ExecuteReader();

                        while (sql2.myReader.Read())
                        {
                            pri_sum = (sql2.myReader["summa"] != DBNull.Value ? sql2.myReader.GetDouble("summa") : 0);
                        }
                        sql2.myReader.Close();

                        var ras = " SELECT sum(summa) as summa FROM products_jur7 where vid_doc = '2' and user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and kol > 0 and ot_kogo = '" + podraz_1 + "' and ot_kogo_2 = '" + podraz_2 + "'  ";
                        sql2.myReader = sql2.return_MySqlCommand(ras).ExecuteReader();

                        while (sql2.myReader.Read())
                        {
                            ras_sum = (sql2.myReader["summa"] != DBNull.Value ? sql2.myReader.GetDouble("summa") : 0);
                        }
                        sql2.myReader.Close();


                        if (saldo_sum != 0 && pri_sum != 0 && ras_sum != 0)
                        {
                            j = i;
                            j = j + 1;
                            ...
                            sheet.Range["b" + myrow + ":b" + myrow].Style.Font.Size = 10;
                            sheet.Range["b" + myrow + ":b" + myrow].Style.Font.FontName = "Times New Roman";
                            sheet.Range["b" + myrow + ":b" + myrow].Text = podraz_2;
                            sheet.Range["b" + myrow + ":b" + myrow].Style.WrapText = true;
                            ...
                            sheet.Range["c" + myrow + ":c" + myrow].Style.Font.Size = 10;
                            sheet.Range["c" + myrow + ":c" + myrow].Style.Font.FontName = "Times New Roman";
                            sheet.Range["c" + myrow + ":c" + myrow].Text = podraz_1;
                            sheet.Range["c" + myrow + ":c" + myrow].Style.WrapText = true;
                            ...
                            sheet.Range["d" + myrow + ":d" + myrow].Style.Font.Size = 10;
                            sheet.Range["d" + myrow + ":d" + myrow].Style.Font.FontName = "Times New Roman";
                            sheet.Range["d" + myrow + ":d" + myrow].Value = saldo_sum.ToString();
                            ...
                            sheet.Range["e" + myrow + ":e" + myrow].Style.Font.Size = 10;
                            sheet.Range["e" + myrow + ":e" + myrow].Style.Font.FontName = "Times New Roman";
                            sheet.Range["e" + myrow + ":e" + myrow].Value = pri_sum.ToString();
                            ...
                            sheet.Range["f" + myrow + ":f" + myrow].Style.Font.Size = 10;
                            sheet.Range["f" + myrow + ":f" + myrow].Style.Font.FontName = "Times New Roman";
                            sheet.Range["f" + myrow + ":f" + myrow].Value = ras_sum.ToString();
                            ...
                            sheet.Range["g" + myrow + ":g" + myrow].Style.Font.Size = 10;
                            sheet.Range["g" + myrow + ":g" + myrow].Style.Font.FontName = "Times New Roman";
                            sheet.Range["g" + myrow + ":g" + myrow].Value = (saldo_sum + pri_sum - ras_sum).ToString();
            ...
            sheet.Range["d2:" + myrow + "g"].NumberFormat = "#,##0.00";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["b1:b1"].ColumnWidth = 17;
            sheet.Range["c1:c1"].ColumnWidth = 29.14;
            sheet.Range["d1:d1"].ColumnWidth = 8;
            sheet.Range["e1:e1"].ColumnWidth = 14;
            sheet.Range["f1:f1"].ColumnWidth = 6;
            sheet.Range["g1:g1"].ColumnWidth = 6;
            sheet.Range["h1:h1"].ColumnWidth = 9;
            ...
            var exl = "SELECT id,product_id,num_doc,ot_kogo_2,naim_tov,sum(kol) as kol,sum(summa) as summa,deb_sch,kre_sch,deb_sch_2 FROM products_rasxod_jur7 where user='" + string_for_otdels + "' and year='" + year_global + "' and month='" + month_global + "' group by product_id";
            ...
            while (sql.myReader.Read())
            {
                ...
                sheet.Range["a" + myrow + ":a" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["a" + myrow + ":a" + myrow].BorderAround(LineStyleType.Thin);
                sheet.Range["a" + myrow + ":a" + myrow].Text = (sql.myReader["num_doc"] != DBNull.Value ? sql.myReader.GetString("num_doc") : "");
                ...
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.Size = 10;
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["b" + myrow + ":b" + myrow].Text = (sql.myReader["ot_kogo_2"] != DBNull.Value ? sql.myReader.GetString("ot_kogo_2") : "");
                sheet.Range["b" + myrow + ":b" + myrow].Style.WrapText = true;
                ...
                sheet.Range["c" + myrow + ":c" + myrow].Style.Font.Size = 10;
                sheet.Range["c" + myrow + ":c" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["c" + myrow + ":c" + myrow].Text = (sql.myReader["naim_tov"] != DBNull.Value ? sql.myReader.GetString("naim_tov") : "");
                sheet.Range["c" + myrow + ":c" + myrow].Style.WrapText = true;
                ...
                sheet.Range["e" + myrow + ":e" + myrow].Style.Font.Size = 10;
                sheet.Range["e" + myrow + ":e" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["e" + myrow + ":e" + myrow].Value = (sql.myReader["summa"] != DBNull.Value ? sql.myReader.GetString("summa") : "");
                ...
                sheet.Range["f" + myrow + ":f" + myrow].Style.Font.Size = 10;
                sheet.Range["f" + myrow + ":f" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["f" + myrow + ":f" + myrow].Text = (sql.myReader["deb_sch"] != DBNull.Value ? sql.myReader.GetString("deb_sch") : "");
                ...
                sheet.Range["g" + myrow + ":g" + myrow].Style.Font.Size = 10;
                sheet.Range["g" + myrow + ":g" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["g" + myrow + ":g" + myrow].Text = (sql.myReader["kre_sch"] != DBNull.Value ? sql.myReader.GetString("kre_sch") : "");
                ...
                sheet.Range["h" + myrow + ":h" + myrow].Style.Font.Size = 10;
                sheet.Range["h" + myrow + ":h" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["h" + myrow + ":h" + myrow].Text = (sql.myReader["deb_sch_2"] != DBNull.Value ? sql.myReader.GetString("deb_sch_2") : "");
            ...
            sheet.Range["d3:" + myrow + "e"].NumberFormat = "#,##0.00";


            workbook.SaveToFile(Environment.CurrentDirectory + "\\docs\\Расш_дебета.xlsx", Spire.Xls.FileFormat.Version2007);
            System.Diagnostics.Process.Start(workbook.FileName);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            workbook.SaveToFile(Environment.CurrentDirectory + "\\docs\\Расш_кредита.xlsx", Spire.Xls.FileFormat.Version2007);
            System.Diagnostics.Process.Start(workbook.FileName);
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("button17_Click " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("button6_Click " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            sheet.Range["e1:e1"].ColumnWidth = 20;


            sheet.Range["a1:d1"].Style.Font.IsBold = true;
            sheet.Range["a1:d1"].Style.Font.IsItalic = true;
            sheet.Range["a1:d1"].Style.Font.FontName = "Times New Roman";
            sheet.Range["a1:d1"].Style.VerticalAlignment = VerticalAlignType.Center;
            sheet.Range["a1:d1"].Style.HorizontalAlignment = HorizontalAlignType.Right;
            sheet.Range["a1:d1"].Style.Font.Size = 12;
            sheet.Range["a1:d1"].Merge(); // birlashtirish
            sheet.Range["a1:d1"].Text = "ГУВД1";
            sheet.Range["a1:d1"].Style.WrapText = true;
            sheet.Range["a1:d1"].Style.Font.Color = Color.DarkBlue;
            sheet.SetRowHeight(1, 20);

            sheet.Range["b2:e2"].Style.Font.IsBold = true;
            sheet.Range["b2:e2"].Style.Font.FontName = "Times New Roman";
            sheet.Range["b2:e2"].Style.VerticalAlignment = VerticalAlignType.Center;
            sheet.Range["b2:e2"].Style.HorizontalAlignment = HorizontalAlignType.Left;
            sheet.Range["b2:e2"].Style.Font.Size = 12;
            sheet.Range["b2:e2"].Merge(); // birlashtirish
            sheet.Range["b2:e2"].Text = "СВОДНАЯ ОБОРОТЪ ЗА Февралъ 2021 год";
            sheet.Range["b2:e2"].Style.WrapText = true;
            sheet.Range["b2:e2"].Style.Font.Color = Color.DarkBlue;
            sheet.SetRowHeight(2, 20);
            ...
            var exl = "SELECT schet FROM gruppa_jur7 group by schet";

            sql.myReader = sql.return_MySqlCommand(exl).ExecuteReader();
            while (sql.myReader.Read())
            {
                schet = (sql.myReader["schet"] != DBNull.Value ? sql.myReader.GetString("schet") : "");
                var saldo = " select id,sum(summa) as summa from saldo_jur7 where user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and deb_sch='" + schet + "' ";
                ...
                var pri = " select sum(summa) as summa from( SELECT * FROM products_jur7 where vid_doc = '1' and user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and deb_sch='" + schet + "'" +
                          " union all" +
                          " SELECT * FROM products_jur7 where vid_doc = '3' and user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and deb_sch='" + schet + "') as t ";
                ...
                var ras = " SELECT sum(summa) as summa FROM products_jur7 where vid_doc = '2' and user = '" + string_for_otdels + "' and year = '" + year_global + "' and month = '" + month_global + "' and deb_sch='" + schet + "' ";
                ...
                sheet.Range["b" + myrow + ":b" + myrow].Merge();
                sheet.Range["b" + myrow + ":b" + myrow].Style.HorizontalAlignment = HorizontalAlignType.Right;
                sheet.Range["b" + myrow + ":b" + myrow].Style.VerticalAlignment = VerticalAlignType.Center;
                sheet.Range["b" + myrow + ":b" + myrow].BorderAround(LineStyleType.Thin);
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.Size = 11;
                sheet.Range["b" + myrow + ":b" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["b" + myrow + ":b" + myrow].Value = saldo_sum.ToString();
                sheet.Range["b" + myrow + ":b" + myrow].Style.WrapText = true;
                ...
                sheet.Range["c" + myrow + ":c" + myrow].Style.Font.Size = 11;
                sheet.Range["c" + myrow + ":c" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["c" + myrow + ":c" + myrow].Value = pri_sum.ToString();
                sheet.Range["c" + myrow + ":c" + myrow].Style.WrapText = true;
                ...
                sheet.Range["d" + myrow + ":d" + myrow].Style.Font.Size = 11;
                sheet.Range["d" + myrow + ":d" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["d" + myrow + ":d" + myrow].Value = ras_sum.ToString();
                ...
                sheet.Range["e" + myrow + ":e" + myrow].Style.Font.Size = 11;
                sheet.Range["e" + myrow + ":e" + myrow].Style.Font.FontName = "Times New Roman";
                sheet.Range["e" + myrow + ":e" + myrow].Value = (saldo_sum - ras_sum + pri_sum).ToString();
            ...
            sheet.Range["b" + myrow + ":b" + myrow].Style.Font.Size = 11;
            sheet.Range["b" + myrow + ":b" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["b" + myrow + ":b" + myrow].Value = saldo_sum_all.ToString();
            sheet.Range["b" + myrow + ":b" + myrow].Style.WrapText = true;
            sheet.Range["b" + myrow + ":b" + myrow].Style.Font.IsBold = true;
            ...
            sheet.Range["c" + myrow + ":c" + myrow].Style.Font.Size = 11;
            sheet.Range["c" + myrow + ":c" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["c" + myrow + ":c" + myrow].Value = pri_sum_all.ToString();
            sheet.Range["c" + myrow + ":c" + myrow].Style.WrapText = true;
            ...
            sheet.Range["d" + myrow + ":d" + myrow].Style.Font.Size = 11;
            sheet.Range["d" + myrow + ":d" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["d" + myrow + ":d" + myrow].Value = ras_sum_all.ToString();
            ...
            sheet.Range["e" + myrow + ":e" + myrow].Style.Font.Size = 11;
            sheet.Range["e" + myrow + ":e" + myrow].Style.Font.FontName = "Times New Roman";
            sheet.Range["e" + myrow + ":e" + myrow].Value = (saldo_sum_all - pri_sum_all + ras_sum_all).ToString();




            sheet.Range["b3:" + myrow + "e"].NumberFormat = "#,##0.00";


            workbook.SaveToFile(Environment.CurrentDirectory + "\\docs\\C.xlsx", Spire.Xls.FileFormat.Version2007);
            System.Diagnostics.Process.Start(workbook.FileName);
